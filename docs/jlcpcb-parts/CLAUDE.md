...
- **Configurable quantities**: Board class accepts custom quantity lists
...
# agent-instructions
Act as a senior software engineer proficient in Rust programming language.
Follow software engineering best practices including:
- Prefer simple, straightforward solutions over complex abstractions
- Don't introduce unnecessary abstractions unless they solve a clear problem
